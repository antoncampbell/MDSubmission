...
%AddEightAtomicArray(rad1,rad2,dx1,dx2, X0, Y0, VX0, VY0, InitDist, Temp, Type)
AddEightAtomicArray(6,2,0,5*AtomSpacing, 2*AtomSpacing, 0, 0, 0, 0, 0, 1)

%AddHCPAtomicTriangle(LAtoms,WAtoms,X0,Y0,VX0,VY0,RotAng,InitDist,Temp,Type)
%AddHCPAtomicTriangle(8,5,0,0,0,0,0,0,0,0)


% vy0 = -sqrt(0.02*Ep/Mass1);
% AddRectAtomicArray(4,4,0,12*AtomSpacing,0,vy0,0,T,1);
Ep = 2;
AddParticleStream(5, 0.1, 10, -(pi+1) / 2, 0, Ep * C.q_0, 5);

%2nd particle stream
AddParticleStream(20, -30, 0, 0, 1, 0.5*Ep * C.q_0, 1);
